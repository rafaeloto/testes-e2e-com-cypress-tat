...
declare namespace Cypress {
  interface Chainable {
     ...
     *
     * @example cy.editNote('Learn Cypress', 'Learn Cypress for improving test coverage') // Edits the description of note with the text 'Learn Cypress' to 'Learn Cypress for improving test coverage'
     * @example cy.editNote('Learn Cypress', 'Learn Cypress for improving test coverage', true) // Edits the description of note with the text 'Learn Cypress' to 'Learn Cypress for improving test coverage', and attaches the `example.json` fixture file to it
     */
